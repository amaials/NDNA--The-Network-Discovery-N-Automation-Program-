...
echo "Building Enterprise Wide NX-OS IP list (For ALL L3 Devices)"
echo ""
find /usr/DataCenters/$Company*/DCDP/* -name "L3-NX-OS-IPs.txt" -exec cat {} \; > /usr/enterprise-wide-routers/Created-IP-Lists/$Company-enterprise-wide-nxos-routers-$date.txt
#
echo "Enterprise Wide NX-OS IP list for $Company (For L3 Devices) Has Completed..."
echo ""