...
echo "Building Enterprise Wide IP list (For ALL L3 Devices)"
echo ""
find /usr/DataCenters/$Company*/DCDP/* -name "L3-*-IPs.txt" -exec cat {} \; > /usr/enterprise-wide-routers/Created-IP-Lists/$Company-enterprise-wide-ios-nxos-routers-$date.txt
#
echo "Enterprise Wide IP list for $Company (For ALL L3 Devices) Has Completed..."
echo ""