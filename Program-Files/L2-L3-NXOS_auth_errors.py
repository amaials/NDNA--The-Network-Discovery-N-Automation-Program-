...
class Logger(object):
    def __init__(self):
        ...
        self.log = open("/usr/DCDP/logs/L2-L3-NXOS-2nd-Auth.log", "w")
...
sys.stderr = open("/usr/DCDP/logs/L2-L3-NXOS-2nd-Auth-ERR.log", 'w')
...
iplist = open('/usr/DCDP/tmp/L2-L3-NXOS_auth_error_iplist.txt').readlines()
