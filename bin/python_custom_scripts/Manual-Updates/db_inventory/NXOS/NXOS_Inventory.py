...
print "            /_____/   "
print "            "
print "                    For NXOS Inventory to MySQL DB:    "
print ""   
print "###############################################################################################" 
...
if len(sys.argv) == 2:
    #ip_file = sys.argv[1]
    sql_file = sys.argv[1]
    print Fore.BLUE + Style.BRIGHT + "\n\n* Excecuting NXOS Device Inventory Program For Export (xml, json, yaml, etc)\n"
...
ip_list = open('/usr/DataCenters/%s/DCDP/good-IPs/NX-OS-IPs.txt' % DataCenter).readlines()
